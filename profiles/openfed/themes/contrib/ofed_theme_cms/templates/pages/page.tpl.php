      ...
      <div class="row">
        ...
        <!-- Region Copyright -->
          <div class="copyright span-9">
            <p><?php echo str_replace('[date:year]', date('Y'), theme_get_setting('cms_theme_copyright_label')); ?> - <?php print $site_name ?></p>
          </div>
        <?php endif; ?>

        <?php if (theme_get_setting('cms_theme_toggle_user_manual')): ?>
        <!-- Region User manual -->
          <div class="user-manual span-3">
            <p><?php echo $distribution_version; ?> - <?php echo $user_manual_link; ?></p>
          </div>
        <?php endif; ?>
