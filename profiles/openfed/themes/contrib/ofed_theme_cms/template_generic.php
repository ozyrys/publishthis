...
function cms_theme_preprocess_page(&$variables) {
  ...
  $variables['distribution_version'] = !empty($info) ? check_plain($info['name'] . ' ' . $info['version']) : '';
  $variables['user_manual_link'] = '<a href="' . theme_get_setting('cms_theme_user_manual_link') . '">User manual</a>';
}
